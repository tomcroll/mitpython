...
print semordnilapWrapper('abc', 'cba') == True
print semordnilapWrapper('aaaaa', 'aaaaa') == False
print semordnilapWrapper('abc', 'cbas') == False
print semordnilapWrapper('abc', 'cca') == False
